...
<head>
  ...
  <title>Dashboard Personal Operativo Isvi</title>
...
<div class="container">
  ...
  <div class="header">
    ...
    <div class="total-display">1492 Colaboradores</div>
  </div>
    ...
    <div class="card">
      ...
      <div class="kpi-grid">
        ...
        <div class="kpi-card danger">
          ...
          <div class="kpi-label">Ene 2025-Marz 2026</div>
        </div>
      </div>
    </div>
...
<ul class="insights-list">
  ...
  <li class="insight-item">
    ...
    <span><strong>Escalamiento Organizacional Global:</strong> La planta crece de 170 a 1492 colaboradores, reflejando un modelo de expansión intensiva basado en contratos de alto impacto y alta demanda operativa.</span>
  </li>
